...
import sistem from "../imgs/Computing.gif";
  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row gap-6 p-5 ml-30 px-3 max-w-6xl mx-auto'>
          ...
          <div className='lg:w-1/2 w-auto'>
              ...
              <img src={sistem} alt="sistem" className="img-fluid" />
              </div>
          </div>
    </div>
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center my-4">
          <h1 className="text-2xl font-semibold justify-left">Learn-Sistem</h1>
