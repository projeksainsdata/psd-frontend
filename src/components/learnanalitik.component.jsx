...
import analitik from "../imgs/Brain.gif";
    ...
    <div className='flex flex-col lg:flex-row gap-6 p-5 ml-30 px-3 max-w-6xl mx-auto'>
          <div className='lg:w-1/2'>
              ...
              <p className='text-gray-500 mt-5 mb-5 text-xl'>
                Disini Anda akan menemukan berbagai artikel dan tutorial tentang topik seperti pemodelan prediktif, pembelajaran mesin, pengembangan algoritma, pengolahan citra, dan pemodelan matematika. Pelajari cara mengubah data menjadi wawasan berharga dengan metode dan teknik analitis terkini.
              </p>
          </div>

          <div className='lg:w-1/2 w-auto'>
              <div className='banner-img position-relative w-auto'>
              <img src={analitik} alt="analitik" className="img-fluid" />
              </div>
          </div>
      </div>
